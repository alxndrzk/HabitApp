...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            val priority = itemView.findViewById<ImageView>(R.id.pager_priority_level)
            ...
            val openCountDown = itemView.findViewById<TextView>(R.id.btn_open_count_down)
            ...
            openCountDown.setOnClickListener {
                onClick(pageData)
            }
