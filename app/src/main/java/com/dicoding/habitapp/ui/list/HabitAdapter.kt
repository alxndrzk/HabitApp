...
class HabitAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HabitViewHolder {
        val habitItem = LayoutInflater.from(parent.context).inflate(R.layout.habit_item, parent, false)
        return HabitViewHolder(habitItem)
    }

    override fun onBindViewHolder(holder: HabitViewHolder, position: Int) {
        //TODO 9 : Get data and bind them to ViewHolder
        val getHabitItem = getItem(position) as Habit
        holder.bind(getHabitItem)
    }
